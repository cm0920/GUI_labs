...
public class GUIone extends JFrame{
    public static void main(String[] args){
        JOptionPane.showConfirmDialog(null, "No Message", "Message Box Example", JOptionPane.OK_CANCEL_OPTION, JOptionPane.ERROR_MESSAGE);
         ...
         */
        JOptionPane.showConfirmDialog(null, "WATCH OUT!!!", "Message Box Example", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE);
        JOptionPane.showConfirmDialog(null, "You are wrong.", "Message Box Example", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.ERROR_MESSAGE);
    }
